...
const ProductInquirySection: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen  p-8 ">
      <div className="bg-white shadow-lg rounded-lg py-8 px-6 sm:py-12 sm:px-10 max-w-2xl w-full">
        ...
        <div className="flex flex-col items-center gap-6 mb-6">
          <input
            ...
            } shadow-md focus:ring-purple-500 focus:border-purple-500`}
          />
          <textarea
            placeholder="Add any remarks (e.g., color, size)"
            value={remarks}
            onChange={(e) => setRemarks(e.target.value)}
            className="w-full lg:w-3/4 p-4 text-gray-800 rounded-lg border border-gray-300 shadow-md focus:ring-purple-500 focus:border-purple-500 h-28 resize-none"
          ></textarea>
        ...
        <div className="flex flex-col gap-4 mt-8">
          ...
          <button
            className="w-full bg-purple-600 text-white py-3 px-8 rounded-lg hover:bg-purple-700 transition duration-300 shadow-lg"
          ...
          <div className="flex justify-center mt-4">
            ...
            >
              Don&apos;s have one? Shop Our Products here!
            </button>
          </div>
        </div>
      </div>
